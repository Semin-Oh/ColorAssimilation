classdef CS2000 < handle
    ...
    %       manual                  Opens manual pdf
    %       documentation           Opens communication specification pdf
    %
    %
    ...
    %   specification document for background information (can be opened
    ...
    methods (Access = public)
        ...
        function close(obj)
            %close closes the serial port. Before that, it tries to 
            %activate the CS2000's display, the measurement switch, and to 
            %disable the remote mode.
    ...
    methods (Static, Hidden)
        ...
        function manual
            %manual opens the Konika Minolta CS-2000/2000A manual.
            open('cs-2000-2000a_instruction_eng.pdf');
        end
        
        function documentation
            %documentation opens the Konika Minolta CS-2000/2000A 
            %communication specification.
            open('cs-20002000a_cs0102_eng.pdf');
        end
    end
end
