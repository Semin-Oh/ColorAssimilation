...
load('SPECTRA_Samsung wide_center_01-Aug-2022.mat') %the dates for these two files should be the same
filetosave = 'calibration_Samsung wide_center_01-Aug-2022.mat';
