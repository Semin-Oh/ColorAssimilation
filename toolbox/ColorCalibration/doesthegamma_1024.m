...
load("SPECTRA_Lab103_16Feb2024_16-Feb-2024.mat") %the dates for these two files should be the same
filetosave = 'calibrationLab103_16-Feb-2024.mat';
...
%     subplot(1,4,ch)
    for val=1:1023
        ...
        Result=SPECTRA{1,val,ch}; % Sconvert from spectruq to threestimulus vqlues
        LUM(val+1,ch)=Result.Y;
        xyY(val+1,ch,:) = [Result.x,Result.y,Result.Y];
