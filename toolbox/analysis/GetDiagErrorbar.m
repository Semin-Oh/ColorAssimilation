function h = GetDiagErrorbar(data,lim,xl,yl)
...
% m = zeros(1,n);
% for i = 1:n
%     m(i) = mean( RandSample(d,[1,length(data)]) );
% end
...
line([x(1) x(3)],y([1 3]),'linewidth',5,'color',[0.5 0.5 0.5]);%2.5
plot(x(2),y(2),'.','markersize',30,'color',[0.5 0.5 0.5]);%15
