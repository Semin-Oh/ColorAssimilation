...
try
    ...
    for ss = 1:nStripeColors

        % Decide which color of stripes to test.
        idxStripeColor = expParams.stripeColorRandOrder(ss);
        stripeColorToTest = expParams.stripeColorOptions{idxStripeColor};
